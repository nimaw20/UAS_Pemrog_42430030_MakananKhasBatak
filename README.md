...
| Portrait | Landscape |
| :---: | :---: |
| ![Main Portrait](screenshot/main_portrait.png) | ![Main Landscape](screenshot/main_landscape.png) |

### 2. Katalog Makanan (List Makanan)
Daftar lengkap makanan khas Batak yang tersedia.
| Portrait | Landscape |
| :---: | :---: |
| ![List Portrait](screenshot/list_portrait.png) | ![List Landscape](screenshot/list_landscape.png) |
...
| :---: | :---: |
| ![Sort A-Z](screenshot/sort_az.png) | ![Sort Z-A](screenshot/sort_za.png) |

### 5. Tambah Data Makanan
Formulir dengan validasi If-Else untuk memasukkan data makanan baru.
| Portrait | Landscape |
| :---: | :---: |
| ![Tambah Portrait](screenshot/tambah_portrait.png) | ![Tambah Landscape](screenshot/tambah_landscape.png) |

### 6. Tentang Aplikasi
Informasi mengenai profil pengembang.
| Portrait | Landscape |
| :---: | :---: |
| ![Tentang Portrait](screenshot/tentang_portrait.png) | ![Tentang Landscape](screenshot/tentang_landscape.png) |
...
![Logcat NIM](screenshot/logcat_nim.png)
